...
public class Dynamic_Array<T> {
    ...
    public Dynamic_Array() {             //initializing the array with 8 units unless the user defines manually.
        this(1);
    }
    @SuppressWarnings("unchecked")
    public Dynamic_Array(int capacity) {         //initializing the array with a custom size
